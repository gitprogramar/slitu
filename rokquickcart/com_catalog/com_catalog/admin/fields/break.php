...
class JFormFieldBreak extends JFormField
{
    ...
    protected function getLabel()
    {
           $doc = JFactory::getDocument();
            $doc->addStyleDeclaration("body label.rok-break, body div.rok-break {font-weight: bold;border-bottom:1px solid #eee;font-size:16px;color:#222;margin-top:15px;margin-bottom: 10px;padding:2px 0;width:100%;min-width:inherit;max-width:inherit;} body label.rok-break.top {margin-top: 0;}");
