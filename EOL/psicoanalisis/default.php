...
<html xml:lang="es-ES" lang="es-ES" >
   <head>
      <title>Diploma - Jornadas EOL</title>
      <meta name="keywords" content="jornadas eol, imprimir, titulo, título, diploma">
      <meta name="viewport" content="width=device-width, initial-scale=1.0">
      <base href="<?= $baseUrl?>">
      <meta property="og:image" content="images/jornadas-eol-17.jpg">
				...
				<form id="form1" class="ajaxForm">
				   ...
				   <div class="row form-group" style="">
					  <div class="col-md-6 col-md-offset-3">
							...
							<input type="hidden" id="file" name="file" value="Certificado 2017">
							<input type="hidden" id="database" name="database" value="data">
							<input type="hidden" id="xyname" name="xyname" value="123,81">
							<input type="hidden" id="xyposition" name="xyposition" value="123,91">
						</div>
				   </div>
