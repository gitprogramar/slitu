(function($) {
	...
	$(document).ready(function () {	
		...
		program.size = size;
		program.headerImage.src = "images/jornadas-" + size + ".jpg";
		...
		$.ajax({
			...
			success: function(data) {
				...
				if(data == "not found"){
					...
					program.showAlert("Diploma descargado", "Gracias por asistir a las XXVI Jornadas Anuales de la EOL", "pastel-info"); 				
					form1.clearAjaxForm();					
				}
			},
